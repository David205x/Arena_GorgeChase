...
Design highlights
-----------------
- Train / val map split  (train=1-8, val=9-10)
...
# ── train / val map split ─────────────────────────────────────────────────────
TRAIN_MAPS = list(range(1, 9))   # maps 1-8
VAL_MAPS   = [9, 10]             # maps 9-10
...
_EVAL_SNAPSHOT_DIR = Path('/workspace/train/backup_model/trajectory').resolve()
